...
export default function DatabaseEvalEventNode({ data }) {
  // state for npc text
  ...
  return (
    <>
      ...
      <Card className="dialogue-event">
        <NodeHeader nodeName="Database Query for Options" id={data.id} />
        <CardContent>
          <FormLabel htmlFor="npc_text">Text:</FormLabel>
          <Textarea
            className="margin-bottom-one"
            minRows={3}
            placeholder="Enter chatbot response here..."
            variant="soft"
            id="npc_text"
            name="npc_text"
