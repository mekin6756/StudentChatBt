...
/// <reference types="node/ts4.8/http" />
/// <reference types="node/https" />
/// <reference types="node/ts4.8/https" />
/// <reference types="node/stream" />
/// <reference types="node/ts4.8/stream" />
/// <reference types="node/net" />
/// <reference types="node/ts4.8/net" />
/// <reference types="node/events" />
/// <reference types="node/ts4.8/events" />
import net from 'net';
